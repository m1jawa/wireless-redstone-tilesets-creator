...
The main goal of WRTC is to take your tileset and create several more with almost equal update priority. <br>

# What's next?

**Here is a list of what I plan to implement in this project**:
<ul>
  <li>GUI</li>
  <li>Protocol generator for cubicmetre's wireless communicators (<a href="https://youtu.be/sBNuqZKa_Lw?si=3zrKEovPADeK8jNn&t=671" target="_blank">Learn more</a>)</li>
  <li>Additional settings such as element configurations, number of repetitions, etc.</li>
</ul>
